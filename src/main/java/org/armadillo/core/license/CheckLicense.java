package org.armadillo.core.license;
...
public class CheckLicense {
     ...
     */
    private static final String PRODUCT_CODE = "PARMADILLO";
    ...
    public static void requestLicense(final String message) {
        ...
        ApplicationManager.getApplication().invokeLater(() -> showRegisterDialog("PARMADILLO", message), ModalityState.NON_MODAL);
    }
